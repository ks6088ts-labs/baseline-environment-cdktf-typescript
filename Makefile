...
STACKS ?= ResourceGroupStack KubernetesClusterStack StorageAccountStack KeyVaultStack AiFoundryStack AiFoundryProjectStack AiServicesStack ApiManagementStack ContainerAppEnvironmentStack ContainerAppStack
