...
STACKS ?= ResourceGroupStack StorageAccountStack KeyVaultStack AiFoundryStack AiServicesStack ApiManagementStack ContainerAppEnvironmentStack ContainerAppStack
